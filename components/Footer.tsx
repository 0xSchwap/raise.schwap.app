      ...
      <div className='flex gap-2 sm:gap-4'>
        <div className="box_shadow">
          <div className='rounded-xl p-2 sm:p-4 bg-gray-200 relative z-10 '>
            <a href="https://twitter.com/0xSchwap" rel="noreferrer" target="_blank">
        ...
        <div className="box_shadow">
          <div className='rounded-xl p-2 sm:p-4 bg-gray-200 relative z-10'>
            <a href="https://schwap.substack.com/" rel="noreferrer" target="_blank">
        ...
        <div className="box_shadow">
          <div className='rounded-xl p-2 sm:p-4 bg-gray-200 relative z-10'>
            <a href="https://docs.schwap.app/" rel="noreferrer" target="_blank">
